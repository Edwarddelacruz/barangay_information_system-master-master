# Generated by Django 3.2.4 on 2021-07-13 08:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='NotificationOfficials',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('message', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('officials_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='barangay_information_app.officials')),
            ],
        ),
        migrations.CreateModel(
            name='Household',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('purok_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='barangay_information_app.purok')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('attendance_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='barangay_information_app.attendance')),
                ('officials_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='barangay_information_app.officials')),
            ],
        ),
        migrations.AddField(
            model_name='attendance',
            name='officials_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='barangay_information_app.officials'),
        ),
        migrations.CreateModel(
            name='AdminHOD',
            fields=[
